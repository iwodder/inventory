...
public interface ProductService {
	...
	Optional<ProductModel> createNewProduct(String name, String category, String location, String unit, int unitsPerCase, String unitPrice, String casePrice);
	...
	Optional<ProductModel> updateProductUnitOfMeasurement(String productId, String unitOfMeasurement, Integer unitsPerCase);
