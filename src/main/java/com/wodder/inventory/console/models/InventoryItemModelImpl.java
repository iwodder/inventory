...
public class InventoryItemModelImpl implements InventoryItemModel {
  ...
  public Result<ProductModel, String> createItem(ProductModel itemDto) {
    ...
    return result
        .<Result<ProductModel, String>>map(inventoryItemDto -> new Result<>(inventoryItemDto, null))
  ...
  public Result<ProductModel, String> updateItem(ProductModel itemDto) {
    Optional<ProductModel> result =
        storage.updateProductCategory(itemDto.getId(), itemDto.getCategory());
    return result
        .<Result<ProductModel, String>>map(i -> new Result<>(i, null))
