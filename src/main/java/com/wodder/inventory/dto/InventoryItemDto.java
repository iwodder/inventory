...
public class InventoryItemDto {
	...
	public InventoryItemDto(String name, String location, String category, String units, String itemsPerCase, String unitPrice, String casePrice, String numberOfUnits, String numberOfCases) {
		this.name = name;
