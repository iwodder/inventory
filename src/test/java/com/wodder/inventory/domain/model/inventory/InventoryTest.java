...
class InventoryTest {
	...
	void from_model() {
		...
		model.addInventoryItem(new InventoryItemDto(new InventoryItem("2% Milk", "Refrigerator",
				"Dairy", new UnitOfMeasurement("Gallon", 4),
				new Price("0.99", "4.98"), new InventoryCount(1.0, 0.25))));
		model.addInventoryItem(new InventoryItemDto(new InventoryItem("Shredded Cheese", "Refrigerator",
				"Dairy", new UnitOfMeasurement("Gallon", 4),
				new Price("0.99", "4.98"), new InventoryCount(1.0, 0.25))));
